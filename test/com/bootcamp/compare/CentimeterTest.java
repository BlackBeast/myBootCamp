...
public class CentimeterTest {
    ...
    @Test
    public void should_be_able_to_add_lengths_units_centimeter_and_millimeter_and_gives_result_in_standard_length_unit_Inch() throws Exception, InvalidTypesException {
        Calculator calculator = Calculator.create(Centimeter.create(1.5),Millimeter.create(10));
